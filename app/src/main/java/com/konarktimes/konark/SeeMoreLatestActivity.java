...
public class SeeMoreLatestActivity extends AppCompatActivity {
    RecyclerView all;
    Toolbar toolbar;
    int lang_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_see_more_latest);
        ...
        all.setLayoutManager(new GridLayoutManager(SeeMoreLatestActivity.this,2));
        getAll();
    ...
    public void getAll(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        all.setAdapter(new NewsAdapter(SeeMoreLatestActivity.this,all_latest,-1));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(SeeMoreLatestActivity.this, "Error:(\n"+error, Toast.LENGTH_SHORT).show();
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(SeeMoreLatestActivity.this);
